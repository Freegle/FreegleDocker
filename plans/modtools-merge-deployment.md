...
### Phase 1 Details
- **Build**: CircleCI #1395
- **Commit**: "Merge origin/master bug fixes into ModTools merge branch"
- **Tests**: Go API ✓, PHPUnit ✓, Playwright E2E ✓
- **Duration**: ~24.5 minutes
- **Auto-merge**: Successfully merged master → production

### Key Changes Deployed
- Restored 16 ModTools methods in stores/message.js
- Restored 3 methods in stores/auth.js (unbounceMT, yahooCodeLogin, merge)
- Added yahooCodeLogin to api/SessionAPI.js
- Fixed MessageHistory.vue approvedby for both Go API and PHP API

## Pre-Deployment Checklist

- [x] All commits reviewed and ready
