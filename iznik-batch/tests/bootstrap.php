...
$_ENV['DB_DATABASE'] = 'iznik_laravel_test';
$_SERVER['DB_DATABASE'] = 'iznik_laravel_test';
putenv('DB_DATABASE=iznik_laravel_test');
...
config(['database.connections.mysql.database' => 'iznik_laravel_test']);

// Ensure test database exists
$pdo = new PDO('mysql:host='.env('DB_HOST'), env('DB_USERNAME'), env('DB_PASSWORD'));
$pdo->exec('CREATE DATABASE IF NOT EXISTS iznik_laravel_test');

// Run migrations (not fresh - preserves existing data for speed)
echo "Running migrate on iznik_laravel_test...\n";
